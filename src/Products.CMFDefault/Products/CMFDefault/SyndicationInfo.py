...
class ISyndicationInfo(ISyndicationInfo):
    ...
    frequency = Int(
        ...
        description=_("This is a multiple of the update period. An"
                      " update frequency of '3' and an update period"
                      " of 'Monthly' will mean an update every three months."),
    )
...
class SyndicationInfo(object):
    ...
    def rfc822(self):
        ...
        return email.rfc822.parsedate(as_zope)
