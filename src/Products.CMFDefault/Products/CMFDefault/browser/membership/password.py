...
class PasswordFormView(SettingsEditFormBase):
    ...
    successMessage = _("Your password has been changed.")
    ...
    def description(self):
        if self.is_first_login:
            return _("This is the first time that you've logged in to "
                     "${portal_title}. Before you start exploring you need "
                     "to change your original password. This will ensure "
                     "that the password we sent you via email cannot be "
                     "used in a malicious manner.",
                     mapping={'portal_title': self.portal_title})
        else:
            return _('Please use the form below to change your password.')
