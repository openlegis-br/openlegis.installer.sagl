...
class BatchFormMixinTests(unittest.TestCase):
    ...
    def _makeOne(self, batch_size=30):
        ...
        batch._get_items = lambda: list(range(batch_size))
        return batch
    ...
    def test_summary_type(self):
        ...
        batch = self._makeOne()
        batch._get_items = lambda: list(range(1))
    ...
    def test_navigation_previous(self):
        ...
        self.assertEqual(batch.navigation_previous(),
                         {'url': 'http://example.com?form.b_start=225',
                          'title': 'Previous ${count} items'}
                         )

    def test_navigation_next(self):
        batch = self._makeOne()
        self.assertEqual(batch.navigation_next(),
                         {'url': 'http://example.com?form.b_start=25',
                          'title': 'Next ${count} items'}
                         )
        batch = self._makeOne(1000)
        batch._getBatchStart = lambda: 250
        self.assertEqual(batch.navigation_next(),
                         {'url': 'http://example.com?form.b_start=275',
                          'title': 'Next ${count} items'}
                         )
    ...
    def test_page_range(self):
        ...
        self.assertEqual(
            batch.page_range(),
            [{'url': 'http://example.com', 'number': 1},
             {'url': 'http://example.com?form.b_start=25', 'number': 2}])
        batch = self._makeOne(1000)
        self.assertEqual(
            batch.page_range(),
            [{'url': 'http://example.com', 'number': 1},
             {'url': 'http://example.com?form.b_start=25', 'number': 2},
             {'url': 'http://example.com?form.b_start=50', 'number': 3},
             {'url': 'http://example.com?form.b_start=75', 'number': 4},
             {'url': 'http://example.com?form.b_start=100', 'number': 5},
             {'url': 'http://example.com?form.b_start=125', 'number': 6},
             {'url': 'http://example.com?form.b_start=150', 'number': 7},
             {'url': 'http://example.com?form.b_start=175', 'number': 8},
             {'url': 'http://example.com?form.b_start=200', 'number': 9},
             {'url': 'http://example.com?form.b_start=225', 'number': 10}])
        batch = self._makeOne(1000)
        batch._getBatchStart = lambda: 250
        self.assertEqual(
            batch.page_range(),
            [{'url': 'http://example.com?form.b_start=150', 'number': 7},
             ...
             {'url': 'http://example.com?form.b_start=200', 'number': 9},
             {'url': 'http://example.com?form.b_start=225', 'number': 10},
             {'url': 'http://example.com?form.b_start=250', 'number': 11},
             {'url': 'http://example.com?form.b_start=275', 'number': 12},
             {'url': 'http://example.com?form.b_start=300', 'number': 13},
             {'url': 'http://example.com?form.b_start=325', 'number': 14},
             {'url': 'http://example.com?form.b_start=350', 'number': 15},
             {'url': 'http://example.com?form.b_start=375', 'number': 16}])
