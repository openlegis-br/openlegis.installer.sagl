...
STATUS = {'submit': _("Item submitted for review."),
          'publish': _("Item was published."),
          'retract': _("Item was retracted."),
          'reject': _("Item was rejected."),
