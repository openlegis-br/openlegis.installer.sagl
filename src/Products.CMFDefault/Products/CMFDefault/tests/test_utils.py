...
'''
    ...
    def test_parseHeadersBody_no_body(self):
        ...
        self.assertTrue('Author' in list(headers.keys()))
        self.assertEqual(headers['Author'], 'Tres Seaver')
        self.assertTrue('Title' in list(headers.keys()))
    ...
    def test_parseHeadersBody_continuation(self):
        ...
        self.assertTrue('Description' in list(headers.keys()))
    ...
    def test_tuplize(self):
        ...
        self.assertEqual(tuplize('unicode', 'one two three'), wanted)
    ...
    def test_toUnicode(self):
        ...
        self.assertEqual(toUnicode('foo'), 'foo')
